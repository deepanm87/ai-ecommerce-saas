  ...
  return (
    <>
      ...
      <div className="fixed top-0 right-0 z-50 flex h-full w-full flex-col border-l border-zinc-200 bg-white overscroll-contain dark:border-zinc-800 dark:bg-zinc-950 sm:w-[448px] animate-in slide-in-from-right duration-300">
        <header className="shrink-0 border-b borer-zinc-200 dark:border-zinc-800">
                ...
                <div className="flex gap-3">
                  ...
                  <div className="flex items-center gap-2 rounded-2xl bg-zinc-100 px-4 py-2 dark:bg-zinc-800">
                    <div className="flex gap-1">
                      ...
                      <span className="h-2 w-2 animate-bounce rounded-full bg-amber-400 [animation-deplay:-0.15s]" />
        ...
        <div className="border-t border-zinc-200 px-4 dark:border-zinc-800">
          <form onSubmit={handleSubmit} className="flex gap-2">
            <Input 
              ...
              placeholder="Asl about our furniture..."
              disabled={isLoading}
              className="flex-1"
            />
            <Button
