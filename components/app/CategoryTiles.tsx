        ...
        <Link
          ...
          className={`group relative shrink-0 overflow-hidden rounded-xl transition-all duration-300 ${
            !activeCategory
              ...
              : "hover:ring-2 hover:ring-zic-300 hover:ring-offset-2 dark:hover:ring-zinc-600 dark:hover:ring-offset-zinc-900"
            }`}
        >
          <div className="relative h-32 w-56 sm:h-56 sm:w-80">
            ...
            <div className="absolute inset-0 bottom-0 p-4">
